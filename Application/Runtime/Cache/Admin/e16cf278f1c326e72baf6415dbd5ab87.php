...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="http://localhost/blog/admin/article.php?a=insert" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" placeholder="标题" id="inputSubject" class="form-control">
                            </div>
                            <div class="form-group">
