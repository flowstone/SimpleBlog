...
<head>
    ...
    <link href="/GitRepository/GitHub/SimpleBlog/Public/Home/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
    <link href="/GitRepository/GitHub/SimpleBlog/Public/Home/css/themify-icons.css" rel="stylesheet" type="text/css" media="all" />
    <link href="/GitRepository/GitHub/SimpleBlog/Public/Home/css/theme.css" rel="stylesheet" type="text/css" media="all" />
    <link href="/GitRepository/GitHub/SimpleBlog/Public/Home/css/custom.css" rel="stylesheet" type="text/css" media="all" />
</head>
<body>
...
<div class="main-container">
    ...
    <section class="page-title page-title-4 bg-secondary">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="uppercase mb0">牛的博客</h3>
                </div>
    ...
    <div class="col-md-9 mb-xs-24">
        <div class="post-snippet mb64">
            <img class="mb24" alt="Post Image" src="/GitRepository/GitHub/SimpleBlog/Public/Home/img/blog-single.jpg" />
            ...
            <blockquote>
                1. PHP 独特的语法混合了 C、Java、Perl 以及 PHP 自创新的语法。<br>
                2. PHP可以比CGI或者Perl更快速的执行动态网页——动态页面方面，与其他的编程语言相比， PHP是将程序嵌入到HTML文档中去执行，执行效率比完全生成htmL标记的CGI要高许多； PHP具有非常强大的功能，所有的CGI的功能PHP都能实现。<br>
                3. PHP支持几乎所有流行的数据库以及操作系统。<br>
                4. 最重要的是PHP可以用C、C++进行程序的扩展！<br>
            </blockquote>
        </div>
        <!--end of post snippet-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <img alt="Logo" class="logo" src="/GitRepository/GitHub/SimpleBlog/Public/Home/img/logo-light1.png" />
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="widget">
...
<script src="/GitRepository/GitHub/SimpleBlog/Public/Home/js/jquery.min.js"></script>
<script src="/GitRepository/GitHub/SimpleBlog/Public/Home/js/bootstrap.min.js"></script>
</body>
</html>